            ...
            <div class="navbar-end">
                <div class="navbar-item">
                    <div class="field is-grouped" style={{paddingRight:'150px'}}>
                        <p class="control">
                            <a  href={`http://localhost:3000/admin/${ad}product`} class="bd-tw-button button is-link is-rounded is-normal" style={{width:'125px', backgroundColor:'transparent',color:'#29465B'}}> 
                            <span>
                                {`${ad} Product`}
                            </span>
                            </a>
